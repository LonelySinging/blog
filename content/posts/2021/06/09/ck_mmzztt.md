...
![image-20210622222510434](ck_mmzztt.assets/image-20210622222510434.png)
...
![image-20210622223049545](ck_mmzztt.assets/image-20210622223049545.png)

看起来很靠谱的样子，使用新的反编译工具`jadx`工具，打开了`dex`文件，突然发现之前的操作都是白给。。。

![image-20210622223222755](ck_mmzztt.assets/image-20210622223222755.png)
